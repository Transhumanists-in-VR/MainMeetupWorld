...
UnityIndirect CreateIndirectLight(float3 normal)
{
    ...
    indirectLight.specular = 0;
        ...
        indirectLight.diffuse = max(indirectLight.diffuse, float(1));
                ...
                switch(float(1))
                {
                    ...
                    case 2: // or wrapped
                    {
                        ...
                        if (float(1) > 0)
                        {
                            ...
                            finalLighting = max(poiLight.finalLighting, poiLight.finalLighting / max(0.0001, (finalluminance / float(1))));
